...
class SecurityManager:
    ...
    def __init__(self, safe_mode: bool = True):
        ...
        self.destructive_keywords = [
            "delete", "rm", "remove", "format", "shutdown", "restart", 
            "erase", "drop", "terminate", "kill", "uninstall", "send_email", "send_message"
        ]
    ...
    def classify_action(self, action_type: str, params: dict = None) -> RiskLevel:
        ...
        if action_type in ["scroll", "speak", "wait_until", "copy_all", "inspect_screen"]:
...
if __name__ == "__main__":
    ...
    print("Delete File Command:", sec.classify_action("type_text", {"text": "rm -rf /"}))
    print("Requires Confirmation for Delete:", sec.requires_user_confirmation("type_text", {"text": "delete all files"}))
