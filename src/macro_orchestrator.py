...
class MacroOrchestrator:
    ...
    def analyze_instruction(self, instruction: str) -> dict:
        ...
        loop_keywords = ["for each", "for every", "every", "each", "repeat", "iterate", "loop", "sequentially"]
        ...
        try:
            ...
            if isinstance(res1, dict) and res1.get("is_loop"):
                ...
                logger.info(f"Macro Orchestrator Pass 2: Extracting Logic for {iterations} iterations...")
